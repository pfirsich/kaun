...
// If we are dealing with general, potentially non-affine transformations, use this (e.g.
// projections) specifically: the last row of the transformation matrix has to be (0, 0, 0, 1),
// otherwise, use this
