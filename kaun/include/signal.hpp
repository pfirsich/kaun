...
public:
    // We use std::function so we can use both static  functions and member functions, that we bind
    // using lambdas, that we cannot directly cast to a function pointer
