...
namespace kaun {
    ...
    protected:
        ...
        RenderTarget() : mColorAttachments(), mDepthStencil(nullptr), mFbo(0),
    ...
    private:
        Window() : RenderTarget() {
            // I don't think it's possible to get the number of multisamples and the kind of attachment for the default FBO (0)
            // but mClearMask = all, mSamples = 0 works for now
