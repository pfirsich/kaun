...
namespace kaun {
    ...
    #define LOG_DEBUG(_msg, ...)    kaun::log(kaun::LogLevel::LVL_DEBUG,    __FILE__, __LINE__, _msg, ##__VA_ARGS__)
    #define LOG_INFO(_msg, ...)     kaun::log(kaun::LogLevel::LVL_INFO,     __FILE__, __LINE__, _msg, ##__VA_ARGS__)
    #define LOG_WARNING(_msg, ...)  kaun::log(kaun::LogLevel::LVL_WARNING,  __FILE__, __LINE__, _msg, ##__VA_ARGS__)
    #define LOG_ERROR(_msg, ...)    kaun::log(kaun::LogLevel::LVL_ERROR,    __FILE__, __LINE__, _msg, ##__VA_ARGS__)
    #define LOG_CRITICAL(_msg, ...) kaun::log(kaun::LogLevel::LVL_CRITICAL, __FILE__, __LINE__, _msg, ##__VA_ARGS__)
}
